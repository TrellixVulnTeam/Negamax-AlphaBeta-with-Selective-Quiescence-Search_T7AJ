            ...
            for horizon in range(4, 7 + 1):
                for approx in range(100, 300 + 1, 100):
                    for run_num in range(12):
                        ...
                        file.write("Horizon-2: " + "\n")
                        file.write("Score: " + str(negamax.alphabeta_quiet(tree.root, horizon-2,
                                                                           negamax.alpha,
                                                                           negamax.beta))
                                   + "\n")
                        file.write("Evaluations: " + str(negamax.evaluations) + "\n")
                        ...
                        file.write("\n")
                        file.write("Horizon-1: " + "\n")
                        file.write("Score: " + str(negamax.alphabeta_quiet(tree.root, horizon-1,
                                                                           negamax.alpha,
                                                                           negamax.beta))
                                   + "\n")
                        file.write("Evaluations: " + str(negamax.evaluations) + "\n")
                        ...
                        file.write("\n")
                        file.write("Horizon: " + "\n")
                        file.write("Score: " + str(negamax.alphabeta_quiet(tree.root, horizon,
                                                                           negamax.alpha,
                                                                           negamax.beta))
                                   + "\n")
                        file.write("Evaluations: " + str(negamax.evaluations) + "\n")
                        negamax.evaluations = 0     # reset evaluations
                        file.write("\n")
                        print("Run no.: " + str(run_num + 1) + "\t" + "b_factor: " + str(b_factor)
...
while run:
    ...
    print("5) Selective Quiescence Search with Alpha Beta")
    print("6) Exit")
    ...
    try:
        ...
        if choice is 1:
            ...
            print("Evaluations: " + str(negamax.evaluations))
            negamax.evaluations = 0     # reset for future searches
            value_is_correct = False    # reset for future
        elif choice is 5:
            print("SELECTIVE QUIESCENCE SEARCH WITH ALPHA BETA ALGORITHM")
            print()
            height = tree.root.height
            while not value_is_correct:
                try:
                    ...
                    print("Enter Valid Integer Value")
            print()
            score = negamax.alphabeta_quiet(tree.root, height, negamax.alpha, negamax.beta)
            print("Score: " + str(score))
            print("Evaluations: " + str(negamax.evaluations))
            negamax.evaluations = 0     # reset for future searches
            value_is_correct = False    # reset for future
